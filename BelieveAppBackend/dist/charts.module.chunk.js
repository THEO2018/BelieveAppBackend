...
var ChartsComponent = (function () {
    function ChartsComponent(authService, toastr, fb, router) {
    ...
    ChartsComponent.prototype.cancel = function () {
        this.router.navigateByUrl('/library');
    };
    ChartsComponent.prototype.showAdd = function () {
        this.add_new = true;
    };
    ChartsComponent.prototype.cancell = function () {
        this.add_new = false;
    };
    /**********************************get image***************************************/
    ChartsComponent.prototype.onFileChange = function (event) {
        console.log(event);
    ...
    /**********************************ADD Albums***************************************/
    ChartsComponent.prototype.AddMedia = function (val) {
        var _this = this;
        ...
        if (!this.myForm.get('image_name').value) {
            ...
            this.authService.addLibrary(data).then(function (result) {
                console.log(result);
                _this.res = result;
                if (_this.res.status == true) {
                    _this.presentToast('Media Added Successfully');
    ...
    /************************************Toast***************************/
    ChartsComponent.prototype.presentToast = function (msg) {
    ...
    ChartsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_4__auth_service_service__["a" /* AuthServiceService */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__charts_routing_module__ = __webpack_require__("../../../../../src/app/layout/charts/charts-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__charts_component__ = __webpack_require__("../../../../../src/app/layout/charts/charts.component.ts");
...
var ChartsModule = (function () {
    ...
    ChartsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["CommonModule"], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["d" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_3__angular_forms__["h" /* ReactiveFormsModule */], __WEBPACK_IMPORTED_MODULE_2_ng2_charts__["ChartsModule"], __WEBPACK_IMPORTED_MODULE_4__charts_routing_module__["a" /* ChartsRoutingModule */], __WEBPACK_IMPORTED_MODULE_6__shared__["b" /* PageHeaderModule */]],
